...
const originalMagicians = ['Merlin', 'Harry Houdini', 'David Copperfield', 'Gandalf'];
// Create a copy of the original array
const copyOfMagicians = [...originalMagicians];
// Call the function to make magicians great and store the result in a new array
const GreatMagicians = Make_great(copyOfMagicians);
